...
namespace Preschool.Controllers
{
    public class ExpensesController : Controller
    {
        ...
        //public async Task<IActionResult> Create([Bind("Id,Amount,Description,RegisterdAt")] Expense expense)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("Id,Amount,Description,RegisterdAt")] Expense expense)
        //{
        //    if (id != expense.Id)
        //    {
        //        return NotFound();
